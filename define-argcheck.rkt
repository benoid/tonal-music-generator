;;  Copyright (c) 2010-2013 John Clements
;;
;; This file was written as part of rsound, 
;; which is available under the terms of the 
;; GNU Lesser General Public License (LGPL)

;; https://github.com/jbclements/RSound/blob/master/LICENSE.txt
